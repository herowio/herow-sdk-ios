...
class CappingFilterTest: XCTestCase {
    ...
    func testValidation() throws {
      //  let testFailExpectation = expectation(description: "testFailExpectation")
        let camp = HerowCampaign(id: "gh", name: "jh", begin: 0, end: nil, cappings: [maxNumberNotifications : 3, minTimeBetweenTwoNotifications : oneDayMilliSeconds], daysRecurrence: [String](), notification: nil, startHour: "09:00", stopHour: "19:15")
    ...
    func testValidation2() throws {
      //  let testFailExpectation = expectation(description: "testFailExpectation")
        let camp = HerowCampaign(id: "gh", name: "jh", begin: 0, end: nil, cappings: [maxNumberNotifications : 3, minTimeBetweenTwoNotifications : 3 * oneDayMilliSeconds], daysRecurrence: [String](), notification: nil, startHour: nil, stopHour: nil)
